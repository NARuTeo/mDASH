  ...
  //
    ...
    for (uint32_t user = 0; user < users; user++)
    {
      DashClientHelper client("ns3::TcpSocketFactory",
          InetSocketAddress(p2pInterfaces.GetAddress(1), port),protocols[user % protoNum]);
      std::cout << user << " client: " << p2pInterfaces.GetAddress(1) << std::endl;
      ...
      ApplicationContainer clientApp = client.Install(wifiStaNodes.Get(1+user));
    ...
    for (uint32_t bulk = 0; bulk < bulkNo; bulk++)
    {
      BulkSendHelper source("ns3::TcpSocketFactory",
          InetSocketAddress(wifiStaInterfaces.GetAddress(2+users+bulk), port));
      ...
      ApplicationContainer sinkApps = sink.Install(
          wifiStaNodes.Get(2+users+bulk));
      sinkApps.Start(Seconds(0.0));
      sinkApps.Stop(Seconds(stopTime));

    }

    GnuplotHelper plotHelper11;
    plotHelper11.ConfigurePlot ("wifi-bitrates1",
                             "bitrates",
                             "Time (seconds)",
                             "bitrates");
    plotHelper11.PlotProbe ("ns3::Uinteger32Probe",
                         "/NodeList/6/ApplicationList/*/$ns3::DashClient/BitRate",
                         "Output",
                         "client",
                         GnuplotAggregator::KEY_INSIDE);
    GnuplotHelper plotHelper12;
    plotHelper12.ConfigurePlot ("wifi-buffer1",
                              "buffer",
                              "Time (seconds)",
                              "buffer");
    plotHelper12.PlotProbe ("ns3::TimeProbe",
                          "/NodeList/6/ApplicationList/*/$ns3::DashClient/Buffer",
                          "Output",
                          "client",
                          GnuplotAggregator::KEY_INSIDE);
    //
    GnuplotHelper plotHelper21;
    plotHelper21.ConfigurePlot ("wifi-bitrates2",
                             "bitrates",
                             "Time (seconds)",
                             "bitrates");
    plotHelper21.PlotProbe ("ns3::Uinteger32Probe",
                         "/NodeList/5/ApplicationList/*/$ns3::DashClient/BitRate",
                         "Output",
                         "client",
                         GnuplotAggregator::KEY_INSIDE);
    GnuplotHelper plotHelper22;
    plotHelper22.ConfigurePlot ("wifi-buffer2",
                              "buffer",
                              "Time (seconds)",
                              "buffer");
    plotHelper22.PlotProbe ("ns3::TimeProbe",
                          "/NodeList/5/ApplicationList/*/$ns3::DashClient/Buffer",
                          "Output",
                          "client",
                          GnuplotAggregator::KEY_INSIDE);
    //
    GnuplotHelper plotHelper31;
    plotHelper31.ConfigurePlot ("wifi-bitrates3",
                             "bitrates",
                             "Time (seconds)",
                             "bitrates");
    ...
    plotHelper32.ConfigurePlot ("wifi-buffer3",
                              "buffer",
                              "Time (seconds)",
                              "buffer");
    ...
    plotHelper41.ConfigurePlot ("wifi-bitrates4",
                             "bitrates",
                             "Time (seconds)",
                             "bitrates");
    ...
    plotHelper42.ConfigurePlot ("wifi-buffer4",
                              "buffer",
                              "Time (seconds)",
                              "buffer");
