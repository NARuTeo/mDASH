...
namespace ns3
{
  ...
  void
  HTTPHeader::SetThroughPut(uint32_t throughput)
  {

    NS_LOG_FUNCTION(this << throughput);
    m_throughput = throughput;
  }
  uint32_t
  HTTPHeader::GetThroughPut(void) const
  {
    NS_LOG_FUNCTION(this);
    return m_throughput;
  }
